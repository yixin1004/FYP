...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/live/chat', [UserController::class, 'LiveChat'])
    ->name('live.chat'); 
    ...
    Route::controller(WishlistController::class)->group(function(){
        ...
        Route::get('/user/wishlist', 'UserWishlist')
        ->name('user.wishlist');
    ...
    Route::controller(CompareController::class)->group(function(){
        ...
        Route::get('/user/compare', 'UserCompare')
        ->name('user.compare');
...
Route::get('/agent/login', [AgentController::class, 'AgentLogin'])->middleware(RedirectIfAuthenticated::class)
->name('agent.login'); 
...
Route::middleware(['auth','roles:admin'])->group(function(){ 
   ...
   Route::controller(PropertyTypeController::class)->group(function(){
    ...
    Route::controller(PropertyController::class)->group(function(){
        ...
        Route::get('/admin/package/history', 'AdminPackageHistory')
        ->name('admin.package.history');

        Route::get('/package/invoice/{id}', 'PackageInvoice')
        ->name('package.invoice');

        Route::get('/admin/property/message/', 'AdminPropertyMessage')
        ->name('admin.property.message');

        Route::get('/admin/message/details/{id}', 'AdminPropertyMessageDetails')
        ->name('admin.property.message.details'); 
...
Route::post('/store/comment', [BlogController::class, 'StoreComment'])
->name('store.comment');

Route::get('/admin/blog/comment', [BlogController::class, 'AdminBlogComment'])
->name('admin.blog.comment');

Route::get('/admin/comment/reply/{id}', [BlogController::class, 'AdminCommentReply'])
->name('admin.comment.reply');

Route::post('/reply/message', [BlogController::class, 'ReplyMessage'])
->name('reply.message');
...
Route::post('/send-message', [ChatController::class, 'SendMsg'])
->name('send.msg');
...
Route::get('/agent/live/chat', [ChatController::class, 'AgentLiveChat'])
->name('agent.live.chat');